...
class testStrUtilsSlicing(unittest.TestCase):
    ...
    def test_reverse_string_slicing_number(self):
        self.assertEqual(reverse_string_slicing("456"), "654")
...
### HOMEWORK 10 ####
"""
10.1 Write your program with a few unit tests.
"""

# Add module with functions from previous homework
# The goal is to write unit-tests!
# import unittest
